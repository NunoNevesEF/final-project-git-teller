...
export type FrequencyMode =
    ...
    | { type: 'MONTHLY_DAY_OF_N_WEEK'; dayOfWeek: DayOfWeek; weekOrdinal: WeekOrdinal; }
...
export const weeklyMode = (dayOfWeek: DayOfWeek): FrequencyMode => ({type: 'WEEKLY', dayOfWeek})

export const daysOfWeekMode = (daysOfWeek: DayOfWeek[]): FrequencyMode => ({type: 'DAYS_OF_WEEK', daysOfWeek})

export const monthlyMode = (dayOfMonth: number): FrequencyMode => ({type: 'MONTHLY_DAY_OF_MONTH', dayOfMonth})

export const monthlyDayOfNWeekMode =
    (dayOfWeek: DayOfWeek, weekOrdinal: WeekOrdinal): FrequencyMode => ({type: 'MONTHLY_DAY_OF_N_WEEK', dayOfWeek, weekOrdinal})

export const monthlyLastDayMode = (): FrequencyMode => ({type: "MONTHLY_LAST_DAY"})
